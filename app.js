...
const itinerary = [
  ...
  { date: '19/07/25', city: 'Budapest', activities: [
    ...
    { desc: 'Llegada y check-in', maps: 'https://goo.gl/maps/6Qw2Qw2Qw2Qw2Qw2A' },
    { desc: 'Supermercado', maps: 'https://goo.gl/maps/8Qw2Qw2Qw2Qw2Qw2A' },
    { desc: 'Parlamento de noche', maps: 'https://goo.gl/maps/1v8Qw2Qw2Qw2Qw2A' },
  ]},
  { date: '20/07/25', city: 'Budapest', activities: [
    { desc: 'Distrito del castillo: Iglesia Matías, Bastión de los Pescadores', maps: 'https://goo.gl/maps/2v8Qw2Qw2Qw2Qw2A' },
    { desc: 'Castillo de Buda', maps: 'https://goo.gl/maps/3v8Qw2Qw2Qw2Qw2A' },
    { desc: 'Funicular', maps: 'https://goo.gl/maps/5v8Qw2Qw2Qw2Qw2A' },
    { desc: 'Comida: Mercado Central de Budapest (Pest)', maps: 'https://goo.gl/maps/7v8Qw2Qw2Qw2Qw2A' },
    { desc: 'Avenida Andrássy y Plaza de la Ópera', maps: 'https://goo.gl/maps/8v8Qw2Qw2Qw2Qw2A' },
    { desc: 'Ópera / Entrada', maps: 'https://goo.gl/maps/9v8Qw2Qw2Qw2Qw2A' },
    { desc: 'Cena por el barrio judío', maps: 'https://goo.gl/maps/0v8Qw2Qw2Qw2Qw2A' },
  ]},
  { date: '21/07/25', city: 'Budapest', activities: [
    { desc: 'Barrio judío y ruin bars', maps: 'https://goo.gl/maps/0v8Qw2Qw2Qw2Qw2A' },
    { desc: 'Isla Margarita', maps: 'https://goo.gl/maps/1v8Qw2Qw2Qw2Qw2B' },
    { desc: 'Paseo en bici' },
    { desc: 'Torre de agua', maps: 'https://goo.gl/maps/2v8Qw2Qw2Qw2Qw2B' },
    { desc: 'Café comercial', maps: 'https://goo.gl/maps/3v8Qw2Qw2Qw2Qw2B' },
  ]},
  // Viena
  { date: '22/07/25', city: 'Viena', activities: [
    { desc: 'Palacio de Schönbrunn (jardines y palacio)', maps: 'https://goo.gl/maps/4v8Qw2Qw2Qw2Qw2B' },
    { desc: 'Café Central', maps: 'https://goo.gl/maps/5v8Qw2Qw2Qw2Qw2B' },
    { desc: 'Comida en Naschmarkt', maps: 'https://goo.gl/maps/6v8Qw2Qw2Qw2Qw2B' },
    { desc: 'Ópera de Viena', maps: 'https://goo.gl/maps/7v8Qw2Qw2Qw2Qw2B' },
  ]},
  { date: '23/07/25', city: 'Viena', activities: [
    { desc: 'Catedral de San Esteban', maps: 'https://goo.gl/maps/8v8Qw2Qw2Qw2Qw2B' },
    { desc: 'Museo Sisi', maps: 'https://goo.gl/maps/9v8Qw2Qw2Qw2Qw2B' },
    { desc: 'Museo Klimt (Palacio Belvedere)', maps: 'https://goo.gl/maps/0v8Qw2Qw2Qw2Qw2B' },
    { desc: 'Café Figlmüller', maps: 'https://goo.gl/maps/1v8Qw2Qw2Qw2Qw2C' },
    { desc: 'Tren: Viena (17:10) → Praga (21:15)', maps: 'https://www.seat61.com/trains-and-routes/vienna-to-prague-by-train.htm' },
  ]},
  // Praga
  ...
  { date: '25/07/25', city: 'Praga', activities: [
    { desc: 'Día organizado por María y Xavier' },
    { desc: 'Tren: Praga (16:39) → Berlín (20:36)', maps: 'https://www.seat61.com/trains-and-routes/prague-to-berlin-by-train.htm' },
  ]},
  // Berlín
  { date: '26/07/25', city: 'Berlín', activities: [
    { desc: 'Tour en bus turístico / bici (hop-on hop-off)', maps: 'https://goo.gl/maps/2v8Qw2Qw2Qw2Qw2C' },
    { desc: 'Puerta de Brandeburgo', maps: 'https://goo.gl/maps/3v8Qw2Qw2Qw2Qw2C' },
    { desc: 'Parlamento alemán', maps: 'https://goo.gl/maps/4v8Qw2Qw2Qw2Qw2C' },
    { desc: 'Monumento al Holocausto', maps: 'https://goo.gl/maps/5v8Qw2Qw2Qw2Qw2C' },
    { desc: 'Checkpoint Charlie', maps: 'https://goo.gl/maps/6v8Qw2Qw2Qw2Qw2C' },
    { desc: 'East Side Gallery', maps: 'https://goo.gl/maps/7v8Qw2Qw2Qw2Qw2C' },
    { desc: 'Paseo por calles céntricas', maps: 'https://goo.gl/maps/8v8Qw2Qw2Qw2Qw2C' },
  ]},
  { date: '27/07/25', city: 'Berlín', activities: [
    { desc: 'Hackescher Markt', maps: 'https://goo.gl/maps/9v8Qw2Qw2Qw2Qw2C' },
    { desc: 'Hackesche Höfe', maps: 'https://goo.gl/maps/0v8Qw2Qw2Qw2Qw2C' },
    { desc: 'Muro de Berlín', maps: 'https://goo.gl/maps/1v8Qw2Qw2Qw2Qw2D' },
    { desc: 'Tren nocturno: Berlín (22:56) → Ámsterdam (06:26)', maps: 'https://www.nsinternational.com/en/train-tickets/berlin-amsterdam' },
  ]},
  // Ámsterdam
  { date: '28/07/25', city: 'Ámsterdam', activities: [
    { desc: 'Bicis'},
    { desc: 'Museo Van Gogh', maps: 'https://goo.gl/maps/3v8Qw2Qw2Qw2Qw2D' },
    { desc: 'Barrio de los canales', maps: 'https://goo.gl/maps/4v8Qw2Qw2Qw2Qw2D' },
  ]},
  { date: '29/07/25', city: 'Ámsterdam', activities: [
    { desc: 'Mercado de las flores', maps: 'https://goo.gl/maps/5v8Qw2Qw2Qw2Qw2D' },
    { desc: 'Barrio De Pijp + Mercado Albert Cuyp', maps: 'https://goo.gl/maps/6v8Qw2Qw2Qw2Qw2D' },
    { desc: 'Parque Vondelpark', maps: 'https://goo.gl/maps/8v8Qw2Qw2Qw2Qw2D' },
  ]},
  // París
  { date: '30/07/25', city: 'París', activities: [
    { desc: 'Tren: Ámsterdam (08:10) → París (11:36)', maps: 'https://www.nsinternational.com/en/train-tickets/amsterdam-paris' },
    { desc: 'Louvre (mediodía)', maps: 'https://goo.gl/maps/0v8Qw2Qw2Qw2Qw2D' },
    { desc: 'Campos Elíseos', maps: 'https://goo.gl/maps/1v8Qw2Qw2Qw2Qw2E' },
    { desc: 'Ópera Garnier', maps: 'https://goo.gl/maps/2v8Qw2Qw2Qw2Qw2E' },
    { desc: 'Arco del Triunfo', maps: 'https://goo.gl/maps/3v8Qw2Qw2Qw2Qw2E' },
    { desc: 'Torre Eiffel (foto nocturna)', maps: 'https://goo.gl/maps/4v8Qw2Qw2Qw2Qw2E' },
  ]},
  { date: '31/07/25', city: 'París', activities: [
    { desc: 'Notre Dame', maps: 'https://goo.gl/maps/5v8Qw2Qw2Qw2Qw2E' },
    { desc: 'Sainte-Chapelle', maps: 'https://goo.gl/maps/6v8Qw2Qw2Qw2Qw2E' },
    { desc: 'Montmartre / Sacré-Cœur (atardecer)', maps: 'https://goo.gl/maps/7v8Qw2Qw2Qw2Qw2E' },
    { desc: 'Pastelería Ladurée o Boris Lumé', maps: 'https://goo.gl/maps/8v8Qw2Qw2Qw2Qw2E' },
  ]},
  { date: '01/08/25', city: 'París', activities: [
    { desc: 'Tren: París (14:21) → Barcelona (21:29)', maps: 'https://www.sncf-connect.com/en-en/train/route/paris/barcelona' },
...
const alojamientos = [
  ...
  },
  {
    ...
    foto: 'https://cf.bstatic.com/xdata/images/hotel/max1024x768/234567890.jpg',
    ubicacion: 'https://goo.gl/maps/abcdVienaAlojamiento'
  },
  {
    ...
    foto: 'https://cf.bstatic.com/xdata/images/hotel/max1024x768/345678901.jpg',
    ubicacion: 'https://goo.gl/maps/abcdPragaAlojamiento'
  },
  {
  ...
  },
  {
    ...
    foto: 'https://cf.bstatic.com/xdata/images/hotel/max1024x768/567890123.jpg',
    ubicacion: 'https://goo.gl/maps/abcdAmsterdamAlojamiento'
  },
  {
